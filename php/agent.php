...
<form action='CrudOperation/addagent.php' method='post'>
                ...
                <input type="text" id="Pname" name="PName" class="check" placeholder="Enter Agent Name" required oninvalid="this.setCustomValidity('Please Enter NIC')" oninput="this.setCustomValidity('')">
                
                        <!--Phone no input-->
                <label>NIC-::</label>
                <input type="tel" id="PhoneNo" class="check" name="nic"placeholder="Enter Valid NIC"  pattern="[0-9]{10}" required oninvalid="this.setCustomValidity('Please Enter 10 Digit Phone No')" oninput="this.setCustomValidity('')">
